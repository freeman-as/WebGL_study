(() => {
    ...
    window.addEventListener ('load', () => {
        ...
        let vs = createShader(vertexSource, gl.VERTEX_SHADER);
        let fs = createShader(fragmentSource, gl.FRAGMENT_SHADER);
     ...
     */
    function loadHeaderShaderSource(vertexSource, fragmentSource, callback){
        let vs, fs;
        vs = vertexSource;
        fs = fragmentSource;
        if(vs != null && fs != null){
